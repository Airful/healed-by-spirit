        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={0.3}>
            <div className="mt-10 text-center">
              <Link
                href="/services"
                className="inline-flex items-center px-8 py-4 bg-purple text-white font-semibold rounded-full hover:bg-purple-dark active:scale-[0.98] transition-all duration-200"
              >
                View All Services
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeIn>
            <div className="text-center mb-16">
              <p className="text-purple font-medium tracking-wide uppercase text-sm mb-2">Testimonials</p>
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-foreground">What My Clients Say</h2>
            </div>
          </FadeIn>
