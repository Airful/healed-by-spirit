    ...
    <>
            ...
            <div>
              ...
              <div className="mt-10 space-y-4">
                <Link
                  ...
                  className="flex items-center gap-4 p-4 rounded-xl border border-border hover:border-purple/30 hover:shadow-md transition-all group"
                >
                  <div className="w-12 h-12 rounded-lg bg-purple/10 flex items-center justify-center shrink-0 group-hover:bg-purple/20 transition-colors">
                    <BookOpen className="h-6 w-6 text-purple" />
                  </div>
                  <div className="flex-1">
                    <p className="font-semibold text-foreground">Print Book</p>
                    <p className="text-sm text-muted-foreground">
                      Single copy or bulk options available
                    </p>
                  </div>
      ...
      <section className="py-20 bg-purple text-white">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center justify-center mt-8 px-8 py-4 bg-white text-purple font-semibold rounded-full hover:bg-white/90 transition-colors"
          >
            Visit Shop
