              ...
              <div>
                ...
                <div className="flex gap-4 mt-6">
                  <a
                    ...
                    className="text-white/60 hover:text-white hover:scale-110 hover:-translate-y-0.5 transition-all duration-200"
                    aria-label="Facebook"
                  >
                  ...
                  >
                    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <path fill="#7b5ea7" d="M9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                    </svg>
                  </a>
                </div>
              </div>
