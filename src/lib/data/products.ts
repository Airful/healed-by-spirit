...
export const products: Product[] = [
  ...
  // Courses
  {
    ...
    description:
      "Seven-module course with Soul Connection at Will Workshop as Module One. Includes six 1-on-1 sessions with Brian, a copy of \"Access The Real You,\" and 60+ page course workbook. All classes recorded.",
    price: 600,
    category: "Courses",
  ...
  // Workshops
  {
    ...
    name: "Soul Connection Workshop (Individual — Group Rate)",
    description: "Access sacred space and connect at soul level. In person or via Zoom.",
    price: 50,
    category: "Workshops",
  },
  {
    slug: "workshop-individual-private",
    name: "Soul Connection Workshop (Individual — Private)",
    description: "Private, in-home or Zoom workshop. Two-person minimum.",
    price: 200,
    category: "Workshops",
  },
  {
    slug: "workshop-couples",
    name: "Soul Connection at Will for Couples (Group Rate)",
  ...
  },
  {
    ...
    name: "Soul Connection for Couples — Private",
    description: "Private couples session with Brian, in-home or via Zoom.",
    price: 300,
    category: "Workshops",
  },
  {
    ...
    description: "Customized corporate workshop program. Price varies based on services provided.",
    price: 0,
  ...
  },
  {
    ...
    name: "Access the Real You for Families (Group Rate)",
    description: "Family workshop at group rate. In person or via Zoom.",
    price: 100,
    category: "Workshops",
  },
  {
    slug: "workshop-families-exclusive",
    name: "Soul Connection for Families — Private",
    description: "Private family session with Brian, in-home or via Zoom.",
    price: 300,
    category: "Workshops",
  },
  // Healer's Curriculum
